...
export default function HomePage() {
  ...
  return (
    ...
    >
      <div className="mx-auto flex min-h-[calc(100vh-2rem)] max-w-4xl flex-col justify-center gap-6 rounded-3xl bg-white/85 p-6 shadow-2xl backdrop-blur-sm dark:bg-slate-950/85">
