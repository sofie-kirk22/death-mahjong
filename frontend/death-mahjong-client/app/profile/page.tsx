  ...
  return (
    ...
    >
      ...
      <div className="mt-4 flex items-end justify-between gap-3">
        <div>
          <p className="text-4xl font-bold">{game.totalSips}</p>
          <p className="text-sm text-slate-500 dark:text-slate-400">sips</p>
        </div>
    ...
    <li className="rounded-xl border border-slate-200 bg-slate-50 p-3 dark:border-slate-700 dark:bg-slate-800">
      <div className="flex items-start justify-between gap-3">
        ...
        <div className="text-right">
          ...
          <p className="text-xs text-slate-500 dark:text-slate-400">sips</p>
        </div>
      </div>
